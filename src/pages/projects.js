              ...
              <li className="p-4 lg:p-6 border">
                <div className="project-details">
                  ...
                  <p>
                    ...
                    powerful page builder extension. Modernizing the interface
                    and optimizing the user experience for a more attractive and
              ...
              <li class="p-4 lg:p-6 border">
                <div class="project-details">
                  ...
                  <p>
                    ...
                    content, aimed at significantly improving the user
                    experience. Also added new pages to comprehensively showcase
                    the various housing models offered by the client. This
                    transformation is intended to make site navigation more
                    user-friendly and provide visitors with a complete and
                    detailed view of the available housing options.
                  </p>
                </div>
              ...
              <li class="p-4 lg:p-6 border">
                <div class="project-details">
                  ...
                  <p>
                    ...
                    virtual showcase to discover and appreciate the quality of
                    our achievements in the field of housing.
                  </p>
                </div>
                <div class="project-tag">
                  <span>Wordpress</span>
              ...
              <li class="p-4 lg:p-6 border">
                <div class="project-details">
                  ...
                  <p>
                    ...
                    the mockup provided by the client. This showcase website
                    aims to introduce the company, its services, and highlight
                    the team. We work meticulously to faithfully reproduce the
              ...
              <li class="p-4 lg:p-6 border">
                <div class="project-details">
                  ...
                  <p>
                    ...
                    latest construction projects. Through this overhaul, we
                    strive to present the ongoing projects in a captivating and
              ...
              <li class="p-4 lg:p-6 border">
                <div class="project-details">
                  ...
                  <p>
                    ...
                    future management for the client. By implementing a
                    harmonious combination of visually appealing elements and an
                    ergonomic structure, we strive to provide a web platform
                    that is both aesthetic and user-friendly, facilitating
                    autonomous and efficient content management by the client.
                  </p>
                </div>
                <div class="project-tag">
                  <span>Figma</span>
            ...
            <ul>
              <li className="p-4 lg:p-6 border">
                <div className="project-details">
                  ...
                  <h3>World clock</h3>
                  <p>
                    Conceived and built a captivating World Clock web
                    application from scratch, which showcased real-time clocks
              ...
              <li class="p-4 lg:p-6 border">
                <div class="project-details">
                  ...
                  <h3>React App</h3>
                  <p>
                    Developed a weather app from scratch using React.js,
                    enabling users to monitor real-time weather for their
                    selected city as well as their current location.
                  </p>
                </div>
                <div class="project-tag">
                  <span>HTML</span>
